...
export function IconButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={twMerge(
        'px-5 py-1.5 text-blue rounded-4xl cursor-pointer transition-colors duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed',
        typeStyles[type],
        className
      )}
      {...props}
